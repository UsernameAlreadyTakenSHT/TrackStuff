...
object Network {
    ...
    val moshi: Moshi = Moshi.Builder().add(NullToEmptyListAdapterFactory()).add(io.github.usernamealreadytakensht.trackstuff.data.remote.tvdb.TvdbCompaniesAdapter()).build()
