...
import io.github.usernamealreadytakensht.trackstuff.data.remote.simkl.SimklApi
import io.github.usernamealreadytakensht.trackstuff.data.remote.simkl.SimklEpisodeRef
import io.github.usernamealreadytakensht.trackstuff.data.remote.simkl.SimklIds
import io.github.usernamealreadytakensht.trackstuff.data.remote.simkl.SimklItem
import io.github.usernamealreadytakensht.trackstuff.data.remote.simkl.SimklMedia
import io.github.usernamealreadytakensht.trackstuff.data.remote.simkl.SimklSeasonRef
import io.github.usernamealreadytakensht.trackstuff.data.remote.simkl.SimklSyncBody
import io.github.usernamealreadytakensht.trackstuff.data.remote.simkl.SimklSyncItem
import io.github.usernamealreadytakensht.trackstuff.data.remote.simkl.SimklSyncResult
...
class SimklSyncService(
    ...
    private suspend fun api(): SimklApi {
        ...
        if (api == null || clientIdUsed != s.simklClientId) {
            api = SimklApi.create(s.simklClientId, io.github.usernamealreadytakensht.trackstuff.BuildConfig.VERSION_NAME) { token }
    ...
    suspend fun sync(): SyncReport {
        ...
        var pullOk = false
        var before: io.github.usernamealreadytakensht.trackstuff.data.remote.simkl.SimklActivities? = null
        try {
    ...
    private suspend fun pullAll(all: io.github.usernamealreadytakensht.trackstuff.data.remote.simkl.SimklAllItems): Int =
