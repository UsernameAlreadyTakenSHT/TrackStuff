package io.github.usernamealreadytakensht.trackstuff.data.imdb

import io.github.usernamealreadytakensht.trackstuff.data.remote.describeError
import android.content.Context
import android.util.Log
import io.github.usernamealreadytakensht.trackstuff.data.local.ImdbAliasEntity
import io.github.usernamealreadytakensht.trackstuff.data.local.ImdbCrewEntity
import io.github.usernamealreadytakensht.trackstuff.data.local.ImdbDao
import io.github.usernamealreadytakensht.trackstuff.data.local.ImdbPersonEntity
import io.github.usernamealreadytakensht.trackstuff.data.local.ImdbSeasonEntity
import io.github.usernamealreadytakensht.trackstuff.data.local.ImdbTitleEntity
import io.github.usernamealreadytakensht.trackstuff.data.local.normalizeTitle
import io.github.usernamealreadytakensht.trackstuff.data.omdborg.CountingInputStream
import io.github.usernamealreadytakensht.trackstuff.data.omdborg.ImportProgress
...
import io.github.usernamealreadytakensht.trackstuff.data.remote.Downloader
...
class ImdbRepository(
    ...
    suspend fun savePoster(imdbId: String, url: String?) = dao.savePoster(io.github.usernamealreadytakensht.trackstuff.data.local.ImdbPosterEntity(imdbId, url ?: "", System.currentTimeMillis()))
    ...
    suspend fun search(query: String): List<MediaSummary> {
        ...
        val match = io.github.usernamealreadytakensht.trackstuff.data.local.ftsQuery(q) ?: return emptyList()
