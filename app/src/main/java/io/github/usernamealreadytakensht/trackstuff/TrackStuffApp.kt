...
import io.github.usernamealreadytakensht.trackstuff.data.local.AppDatabase
import io.github.usernamealreadytakensht.trackstuff.data.local.ImdbDatabase
import io.github.usernamealreadytakensht.trackstuff.data.local.OmdbOrgDatabase
...
class AppContainer(context: Context) {
    ...
    val backup = io.github.usernamealreadytakensht.trackstuff.data.repository.LibraryBackup(database.mediaDao(), library)
...
class TrackStuffApp : Application(), coil.ImageLoaderFactory {
    ...
    override fun onCreate() {
        ...
        container.appScope.launch {
            ...
            io.github.usernamealreadytakensht.trackstuff.data.remote.RefreshLimiter.load(container.settings.refreshLimits())
        }
        io.github.usernamealreadytakensht.trackstuff.data.remote.RefreshLimiter.persist = { map -> container.appScope.launch { container.settings.saveRefreshLimits(map) } }
